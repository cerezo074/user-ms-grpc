...
type Credentials struct {
	...
	ServerTransportProtocol string `mapstructure:"SERVER_TRANSPORT_PROTOCOL"`
...
func (object Credentials) FullServerAddress() string {
	return object.ServerAddress + ":" + object.ServerPort
}
